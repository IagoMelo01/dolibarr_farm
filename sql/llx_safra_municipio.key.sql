...
ALTER TABLE llx_safra_municipio ADD CONSTRAINT llx_safra_municipio_fk_user_creat FOREIGN KEY (fk_user_creat) REFERENCES llx_user(rowid);
ALTER TABLE llx_safra_municipio ADD INDEX idx_safra_municipio_status (status);
-- END MODULEBUILDER INDEXES

--ALTER TABLE llx_safra_municipio ADD UNIQUE INDEX uk_safra_municipio_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_safra_municipio ADD CONSTRAINT llx_safra_municipio_fk_field FOREIGN KEY (fk_field) REFERENCES llx_safra_myotherobject(rowid);
