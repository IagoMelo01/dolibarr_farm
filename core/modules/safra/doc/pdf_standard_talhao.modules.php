...
class pdf_standard_talhao extends ModelePDFTalhao
{
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (getDolGlobalString('MAIN_GENERATE_TALHAO_WITH_PICTURE'))
		{
		...
		*/
		...
		if ($conf->safra->dir_output.'/talhao') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->safra->dir_output.'/talhao';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->safra->dir_output.'/talhao/'.$objectref;
