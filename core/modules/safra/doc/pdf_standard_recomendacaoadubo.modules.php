...
class pdf_standard_recomendacaoadubo extends ModelePDFRecomendacaoAdubo
{
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (getDolGlobalString('MAIN_GENERATE_RECOMENDACAOADUBO_WITH_PICTURE'))
		{
		...
		*/
		...
		if ($conf->safra->dir_output.'/recomendacaoadubo') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->safra->dir_output.'/recomendacaoadubo';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->safra->dir_output.'/recomendacaoadubo/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('SAFRA_DRAFT_WATERMARK')) {
